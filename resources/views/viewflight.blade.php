...
<!-----------------------------end-------------------->
 ...
 <table class="text-center">
      ...
      <td>{{$value['ecost']}}</td>
      <td>{{$value['fcost']}}</td>
      <td><a href={{"update/".$value->id}} class="nav-item text-decoration-none text-white">Update</a>
      <a href={{"delete/".$value->id}} class="nav-item text-decoration-none text-white">Delete</a></td>
      </tr>
      @endforeach
